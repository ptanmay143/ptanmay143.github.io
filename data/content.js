  ...
  projects: [
    {
      title: "Recipe Net",
      description:
        "Built a recipe recommendation system that suggests recipes based on user-inputted ingredients. Scraped 7,918 recipes and used cosine similarity for matching.",
      link: "https://github.com/ptanmay143/recipe-net",
    },
    {
      title: "Virtual Therapist",
      description:
        "Developed an AI-driven chatbot trained on therapist responses from well-being forums. Implemented JavaScript web widget for seamless integration.",
      link: "https://github.com/ptanmay143/virtual-therapist",
    },
    {
      title: "AWS Honeypot Dashboard",
      description:
        "Analyzed AWS honeypot cyberattacks dataset to identify major sources of malicious activity. Built 3 Power BI dashboards for stakeholders.",
      link: null,
    },
    {
      title: "NHANES Interactive Dashboard",
      description:
        "Designed an interactive health data dashboard in Seaborn analyzing BMI, physical activity, and nutrient correlations with demographic filters.",
      link: null,
    },
    {
      title: "Rummy with Friends",
      description:
        "Built a multiplayer rummy game with real-time synchronization using client-server model, network sockets, and RPC for player interactions.",
      link: "https://github.com/ptanmay143/rummy-with-friends",
    },
    {
      title: "Hotel Booking Website",
      description:
        "Developed a responsive hotel booking website with Bootstrap 5, client-side validation, and MySQL database managed by Node.js connector.",
      link: null,
    },
  ],
